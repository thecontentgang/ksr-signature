        ...
        <div className="px-4 lg:px-6 py-2.5 lg:py-3 flex items-center gap-2 lg:gap-6">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center justify-center min-w-[44px] min-h-[44px] gap-2 px-6 py-2.5 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-sm font-bold rounded-full shadow-lg hover:shadow-xl hover:-translate-y-1 hover:from-amber-600 hover:to-orange-600 transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-orange-500"
            >
              ...
              <div className="p-4 flex flex-col gap-1">
                ...
                <div className="pt-3 mt-2 border-t border-gray-100">
                  <button
                    ...
                    className="flex items-center justify-center min-h-[44px] gap-2 w-full py-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white font-bold text-lg rounded-xl shadow-md hover:shadow-lg transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-orange-500"
                  >
