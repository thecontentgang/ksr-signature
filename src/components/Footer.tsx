            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-300 text-sm leading-relaxed">
                    KSR Signature 4,<br />
                    KSR HOMES INDIA PVT LTD<br />
                    Osman Nagar Road, Tellapur, 502034
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@ksrhomes.co.in" className="text-slate-300 text-sm hover:text-sandstone transition-colors inline-flex items-center min-h-[44px] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white focus-visible:ring-offset-ksr-dark rounded-md">
                   info@ksrhomes.co.in
                  </a>
                </div>
              </div>
